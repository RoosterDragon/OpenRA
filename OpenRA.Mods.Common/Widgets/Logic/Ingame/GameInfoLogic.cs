...
namespace OpenRA.Mods.Common.Widgets.Logic
{
	...
	sealed class GameInfoLogic : ChromeLogic
	{
		...
		public sealed class GameInfoLogicDynamicWidgets : DynamicWidgets
		{
		...
		{
			dynamicWidgets.LoadWidget(mapPanelContainer, "MAP_PANEL", []);
		}
		...
		void SetupDebugPanel(ButtonWidget debugTabButton, Widget debugPanelContainer)
		{
			...
			dynamicWidgets.LoadWidget(debugPanelContainer, "DEBUG_PANEL", []);
