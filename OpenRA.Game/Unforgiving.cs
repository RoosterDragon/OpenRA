	...
	public static class Unforgiving
	{
		...
		public static ConstructorInfo GetConstructorUnforgiving(this Type type, Type[] types)
		{
			return type.GetConstructor(types)
				.ArgumentExOnNull(nameof(types), "the public instance constructor whose parameters match the types in the parameter type array was not found");
		}
		...
		public static MethodInfo GetGetMethodUnforgiving(this PropertyInfo propertyInfo, bool nonPublic)
		{
			return propertyInfo.GetGetMethod(nonPublic)
				.InvalidOperationExOnNull($"{nameof(nonPublic)} is false and the get accessor is non-public, or {nameof(nonPublic)} is true but no get accessors exist");
		}
